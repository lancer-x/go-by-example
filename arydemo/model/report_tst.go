...
CREATE TABLE `report_test` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=204 DEFAULT CHARSET=utf8 COMMENT='growth回传测试记录表'

JSON Sample
-------------------------------------
{    "created_at": "2041-03-11T02:29:16.831340209+08:00",    "type": "EnrGIwXeurrWNhRoDUOcXnIln",    "body": "ZjovlgUwlNsJpiVeNJGHyaLXP",    "header": "dKGIUyGqlTVeNSOoonRLmYYqN",    "conv_time": "IPbWdloQSjSIUAMucqtebMBfN",    "account_id": "YGKxhIifhfrmgLZdtJPGiNWka",    "token": "JBbpNtdtupmvdegcmMCOjWllj",    "purchase_amount": "huvbDGlxaRZrEgwObXLxDwUOb",    "id": 85,    "callback": "nXvKUcMGaNPqiqnMKbHouwJWf",    "actions": "bwjOmYkLIRUcBbkldKCGTOqwj",    "js_event_type": 72,    "updated_at": "2116-10-18T04:51:40.895995176+08:00",    "conversion_types": "TrokqkTHxdlLEjvrFDsHODJAt",    "source": "leijaGYLHxmoqSjLEImXUHTwA",    "user_action_set_id": "wNcntibVrQErVYYjmQkkqoIwx"}
...
func (r *ReportTest) BeforeSave() error {
	return nil
}
